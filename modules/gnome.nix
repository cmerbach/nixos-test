   ...
   programs.dconf.profiles.user.databases = [{
    settings = {
      ...
      "org/gnome/shell" = {
        ...
        disabled-extensions = lib.gvariant.mkArray ["disabled"];
      ...
      "org/gnome/shell/extensions/executor" = {
        ...
        left-active = false;
        left-index = lib.gvariant.mkInt32 0;
        center-active = false;
        center-index = lib.gvariant.mkInt32 0;
        right-active = true;
        right-index = lib.gvariant.mkInt32 0;
      ...
      "org/gnome/shell/extensions/docker" = {
        quicksettings-columns = lib.gvariant.mkInt32 1;
      ...
      "com/github/amezin/ddterm" = {
        ...
        window-size = lib.gvariant.mkDouble 0.6;
        ddterm-toggle-hotkey = lib.gvariant.mkArray ["<SHIFT><Control><Alt>a"];
        shortcut-terminal-copy = lib.gvariant.mkArray ["<Control>c"];
        shortcut-terminal-paste = lib.gvariant.mkArray ["<Control>v"];
        shortcut-background-opacity-inc = lib.gvariant.mkArray ["<Control><SHIFT>plus"];
        shortcut-background-opacity-dec = lib.gvariant.mkArray ["<Control><SHIFT>-"];
      };
      ...
      "org/gnome/desktop/wm/keybindings" = {
        ...
        maximize = lib.gvariant.mkArray ["<Control><Alt>UP"];
        unmaximize = lib.gvariant.mkArray ["<Control><Alt>DOWN"];
      };
